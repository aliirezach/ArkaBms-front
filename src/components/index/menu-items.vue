          ...
          <div class="col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 mb-3">
                ...
                <div class="menu-item p-0 m-0">
                  <!--begin:Menu link-->
                  <a href="../../demo1/dist/layouts/dark-header.html" class="menu-link active">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
																		</span>
              ...
              <div class="col-lg-6 mb-3">
                ...
                <div class="menu-item p-0 m-0">
                  ...
                  <a href="../../demo1/dist/toolbars/accounting.html" class="menu-link">
                    ...
                    <span class="menu-title">اکانتینگ</span>
                  </a>
                  <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
    ...
    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
      ...
      <div class="menu-item">
        ...
        <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs" target="_blank"
           title="اسناد کامل را بررسی کنید" data-bs-toggle="tooltip" data-bs-trigger="hover"
...
export default {
  name: "menu-items",
  created() {
    // if (document.getElementById("js-script-addition1") == null) {

      let recaptchaScript1 = document.createElement("script");
      recaptchaScript1.setAttribute("src", "/assets/plugins/global/plugins.bundle.js");
      recaptchaScript1.setAttribute("id", "js-script-addition1");
      document.head.appendChild(recaptchaScript1);
    // }

    // if (document.getElementById("js-script-addition2") == null) {

      let recaptchaScript2 = document.createElement("script");
      recaptchaScript2.setAttribute("src", "/assets/js/scripts.bundle.js");
      recaptchaScript2.setAttribute("id", "js-script-addition2");
