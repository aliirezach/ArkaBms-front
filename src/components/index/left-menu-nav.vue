      ...
      <div
        ...
        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
          ...
          <div class="menu-sub menu-sub-dropdown w-175px py-4">
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3">
              <a href="../../demo1/dist/account/statements.html" class="menu-link px-5">پرداخت ها</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-3">
              <a href="../../demo1/dist/account/statements.html" class="menu-link d-flex flex-stack px-5">بیانه
                ها
